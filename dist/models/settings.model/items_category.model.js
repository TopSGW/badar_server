...
var items_category = new _mongoose.Schema({
  _id: {
    type: Number,
    required: true
  },
...
items_category.plugin(_mongooseI18nLocalize["default"], {
  locales: ['ar', 'en']
});

var _default = _mongoose["default"].model('items_category', items_category);
