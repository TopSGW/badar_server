...
var marketing_category = new _mongoose.Schema({
  _id: {
    type: Number,
    required: true
  },
...
marketing_category.plugin(_mongooseI18nLocalize["default"], {
  locales: ['ar', 'en']
});

var _default = _mongoose["default"].model('marketing_category', marketing_category);
